...
const DEMO_PRODUCTS: StorefrontProduct[] = [
  demoProduct({
    ...
    category: "会员",
    categoryLabel: "会员",
    cover: "/storefront/cover-plus.png?v=4",
    priceCents: 15000,
    hue: 168,
    mark: "Plus",
  ...
  demoProduct({
    ...
    category: "会员",
    categoryLabel: "会员",
    cover: "/storefront/cover-pro-5x.png?v=4",
    priceCents: 85000,
    hue: 170,
    mark: "Pro",
    subtitle: "官方渠道 · 付款后立即出卡",
  ...
  demoProduct({
    ...
    category: "会员",
    categoryLabel: "会员",
    cover: "/storefront/cover-pro.png?v=4",
    priceCents: 115500,
    hue: 172,
    mark: "Pro",
    subtitle: "官方渠道 · 付款后立即出卡",
  ...
  demoProduct({
    ...
    category: "gpt点数",
    categoryLabel: "gpt点数",
    cover: "/storefront/cover-codex-250.png?v=4",
    priceCents: 11100,
    hue: 175,
    mark: "250",
    subtitle: "官方渠道 · 付款后立即出卡",
  ...
  demoProduct({
    ...
    category: "gpt点数",
    categoryLabel: "gpt点数",
    cover: "/storefront/cover-codex-500.png?v=4",
    priceCents: 22200,
    hue: 178,
    mark: "500",
    subtitle: "官方渠道 · 付款后立即出卡",
  ...
  demoProduct({
    ...
    category: "gpt点数",
    categoryLabel: "gpt点数",
    cover: "/storefront/cover-codex-1000.png?v=4",
    priceCents: 33300,
    hue: 180,
    mark: "1000",
    subtitle: "官方渠道 · 付款后立即出卡",
