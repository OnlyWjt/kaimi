    ...
    <div className="space-y-4">
      <section className="km-panel space-y-3">
        ...
        <ol className="km-guide-steps">
          ...
          <li>
            选店铺主题、改一个好记的店铺名，点「保存店铺设置」。再把每个套餐的零售价填进「可填区间」（不能低于成本，也不能超过上限）。
          </li>
      ...
      <section className="km-panel space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-5 text-sm text-[var(--km-fg-muted)]">
          ...
          <li>
            卡密丢了：回店铺页查单。只填邮箱只能看到卡密后几位；要完整卡密必须用订单号。你也能在后台「我的卡密」里帮他看。
          </li>
        </ul>
      </section>
      ...
      <section className="km-panel space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-5 text-sm text-[var(--km-fg-muted)]">
          <li>「我的卡密」是已经卖给客户的，不要自己拿去兑换，兑掉等于把客户的货用了。</li>
